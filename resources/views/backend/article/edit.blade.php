                                    ...
                                    @else
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control w-50" name="categories_id">
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option value="{{ $category->id }}" {{($category->id == $data->categories_id) ? 'selected' : ''}} >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input value="{{ $data->url }}" type="text" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="checkbox">
                                                    <label>
                                                        <input {{ $data->is_active ? 'checked':'' }} type="checkbox"
