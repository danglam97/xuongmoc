                    ...
                    <form role="form" action="{{route('admin.vendor.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            @if($errors->has('name'))
                                ...
                                <input value="{{old('name')}}" type="text" class="form-control" id="title" name="name" placeholder="Nhập tên đối tác">
                            ...
                            @if($errors ->has('image'))
                                ...
                                <input value="{{old('content_title')}}" type="text" class="form-control" id="content_title"
                                       name="content_title" placeholder="Nhập tiêu đề">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    @if($errors->has('email'))
                                        ...
                                        <input type="email" class="form-control" id="url" name="email" placeholder="Email" value="{{old('email')}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" name="content_description" class="form-control" rows="10" placeholder="Enter ...">{{old('content_description')}}</textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
